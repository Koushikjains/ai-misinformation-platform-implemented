        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-5">
          <div className="flex-1 flex flex-col sm:flex-row gap-4">
            <div className="relative flex-1">
              <label className="block text-xs text-[#00f0ff] mb-2 uppercase tracking-wider font-cyber">
                Model Type
              </label>
              <div className="relative">
                <select
                  ...
                  className="w-full appearance-none bg-[#1a1a2e] border border-[#00f0ff]/30 text-white rounded-lg px-4 py-3 pl-10 focus:outline-none focus:ring-2 focus:ring-[#00f0ff]/50 cursor-pointer"
                >
                  <option value="deep_learning">Deep Learning (DistilBERT)</option>
                  <option value="classic">Classic ML (Logistic)</option>
                </select>
                <div className="absolute left-3 top-1/2 -translate-y-1/2 text-[#00f0ff]">
                  {modelType === "deep_learning" ? <Brain size={18} /> : <Cpu size={18} />}
                </div>
                <div className="absolute right-3 top-1/2 -translate-y-1/2 text-[#00f0ff] pointer-events-none">
            ...
            <div className="relative flex-1">
              <label className="block text-xs text-[#ff00ff] mb-2 uppercase tracking-wider font-cyber">
                Region Filter
              </label>
              <div className="relative">
                <select
                  ...
                  className="w-full appearance-none bg-[#1a1a2e] border border-[#ff00ff]/30 text-white rounded-lg px-4 py-3 pl-10 focus:outline-none focus:ring-2 focus:ring-[#ff00ff]/50 cursor-pointer"
                >
                  <option value="global">Global</option>
                  <option value="india">India</option>
                </select>
                <div className="absolute left-3 top-1/2 -translate-y-1/2 text-[#ff00ff]">
                  {region === "global" ? <Globe size={18} /> : <MapPin size={18} />}
                </div>
                <div className="absolute right-3 top-1/2 -translate-y-1/2 text-[#ff00ff] pointer-events-none">
                  <svg width="12" height="12" viewBox="0 0 12 12" fill="currentColor">
                    <path d="M2 4L6 8L10 4" stroke="currentColor" strokeWidth="2" fill="none" />
                  </svg>
                </div>
