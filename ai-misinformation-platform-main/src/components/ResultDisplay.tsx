        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          ...
          {!isInvalid && modelType === "classic" && (
            <motion.button
              ...
              className="mt-8 px-6 py-3 bg-gradient-to-r from-[#ff00ff] to-[#cc00cc] text-white font-bold rounded-lg flex items-center gap-2 hover:shadow-[0_0_30px_rgba(255,0,255,0.5)] transition-all disabled:opacity-50"
            >
              <Sparkles size={20} />
              {isExplaining ? "Generating..." : "Explain Why (LIME)"}
            </motion.button>
          )}
        </div>
      </div>
